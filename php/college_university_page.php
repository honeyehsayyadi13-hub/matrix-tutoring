...
<html>
<head>
    <meta name="description" content="College and University Preparation Information">
    <meta name="keywords" content="college, university, preparation, tutoring, information">
    <meta name="author" content="Honeyeh Sayyadi">
    <title>college and university preparation</title>
...
<!--heading-->
<h1 class="centre-txt-main">College and University Preparation</h1>
<!--image-->
<div class="img-flex"><img src="../img/college_university.jpg" id="main-img" alt="college and university preparation tutoring"></div>
<!--description-->
<h2 class="centre-txt">Aimed towards high school students who want to get ahead. We provide skill-building for post-secondary education readiness.</h2>
