...
<html>
<head>
    <meta name="description" content="Learning and Studying Coaching Information">
    <meta name="keywords" content="learning, studying, coaching, tutoring, information">
    <meta name="author" content="Honeyeh Sayyadi">
    <title>learning and studying coaching</title>
...
<!--heading-->
<h1 class="centre-txt-main">Learning and Studying Coaching</h1>
<!--image-->
<div class="img-flex"><img src="../img/learning_coaching.jpg" id="main-img" width="1000" alt="learning and studying coaching tutoring"></div>
<!--description-->
<h2 class="centre-txt">For students who need guidance on note-taking, organization, and study strategies.</h2>
