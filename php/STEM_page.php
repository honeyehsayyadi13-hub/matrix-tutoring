...
<html>
<head>
    <meta name="description" content="STEM Program Information">
    <meta name="keywords" content="STEM, sciences, program, tutoring, information">
    <meta name="author" content="Honeyeh Sayyadi">
    <title>stem program</title>
...
<!--heading-->
<h1 class="centre-txt-main">STEM Program</h1>
<!--image-->
<div class="img-flex"><img src="../img/stem.jpg" id="main-img" alt="english tutoring"></div>
<!--description-->
<h2 class="centre-txt">Tutoring aimed towards students looking for general help or enrichment in all STEM fields.</h2>
