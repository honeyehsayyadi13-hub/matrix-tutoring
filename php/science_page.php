...
<html>
<head>
    <meta name="description" content="Science Information">
    <meta name="keywords" content="Sciences, biology, chemistry, physics, tutoring, information">
...
<!--heading-->
<h1 class="centre-txt-main">Sciences (Chemistry, Biology, Physics) Tutoring Service</h1>
<!--image-->
<div class="img-flex"><img src="../img/science.jpg" id="main-img" alt="science tutoring"></div>
<!--description-->
<h2 class="centre-txt">Geared towards high school students taking chemistry, biology, and or physics. This program includes homework help and lesson help, as well as test and exam preparation when needed.</h2>
