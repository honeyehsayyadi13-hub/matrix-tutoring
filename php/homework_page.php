...
<html>
<head>
    <meta name="description" content="Homework Information">
...
<!--heading-->
<h1 class="centre-txt-main">Homework Help Tutoring Service</h1>
<!--image-->
<div class="img-flex"><img src="../img/homework.jpg" id="main-img" alt="homework help tutoring"></div>
<!--description-->
<h2 class="centre-txt">For students who need assistance with assignments, homework, and projects.</h2>
